            ...
            <div>
                ...
                <div class="addcours-card__face _fonBack-navy__blue">
                    ...
                    <div class="addcours-card__face-inps">
                        <DivInput class="regLog__textarea" label={<p>Фамилия имя</p>}>
                            <input
                        ...
                        <DivInput class="regLog__textarea" label={<p>Логин</p>}>
                            <input
                                type="text"
                                class="addcours-card__face-inp"
                                placeholder="Логин"
                        ...
                        <DivInput class="regLog__textarea" label={<p>Пароль <span style={{ color: "red" }}>*</span></p>}>
                            ...
                            <div class="input-password__icon" onClick={() => setShowPassword(!showPassword)}>
                ...
                <div class="addcours__title">Прикрепить курс</div>

                <div class="medotisCourse__list">


                    <Select handleChange={addItemsCourse} />

                    <div class="medotisCourse__item">
                        <div class="medotisCourse__name">Курс 1</div>
                        <div class="medotisCourse__button">
